...
public class AptitudeDatabaseHelper extends SQLiteOpenHelper {

    // Database name
    public static String DATABASE_QUESTION = "AptitudequestionBank.db";
    // Current version of database
    private static final int DATABASE_VERSION = 4;
    // Database table name
    private static final String TABLE_QUESTION = "AptitudeQuestionBank";
    ...
    public AptitudeDatabaseHelper(Context context) {
