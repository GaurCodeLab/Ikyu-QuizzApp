...
public class ScienceDataHelper extends SQLiteOpenHelper {
    // Database name
    public static String DATABASE_QUESTION = "SciencequestionBank.db";
    // Current version of database
    private static final int DATABASE_VERSION = 3;
    // Database table name
    private static final String TABLE_QUESTION = "ScienceQuestionBank";
    ...
    public ScienceDataHelper(Context context) {
