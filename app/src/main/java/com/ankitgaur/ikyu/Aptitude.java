...
public class Aptitude extends AppCompatActivity {
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber < mQuestionBank.getLength() ){
            ...
            Toast.makeText(Aptitude.this, "It was the last question!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Aptitude.this, Highest_Score.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            ...
            mScore = mScore + 1;
            Toast.makeText(Aptitude.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(Aptitude.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
